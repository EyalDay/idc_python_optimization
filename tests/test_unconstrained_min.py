...
class TestGradientDecsent(unittest.TestCase):
    ...
    def _test_some_func(self, func):
        ...
        is_sucess, last_point, X1, X2 = line_search(f=func, x0=x_0, step_size=step_size, max_iter=max_iteration,
                                                         obj_tol=obj_tolerance, param_tol=step_tol, dir_selection_method='nt')
    ...
    def _test_lin_min(self):
        ...
        is_sucess, last_point, X1, X2 = line_search(f=my_linear_func, x0=x_0, step_size=step_size,
    ...
    def test_rosenbrock_min(self):
        ...
        is_sucess, last_point, X1, X2 = line_search(f=rosenbrock, x0=x_0, step_size=step_size,
                                                         max_iter=max_iteration,
                                                         obj_tol=obj_tolerance, param_tol=step_tol, dir_selection_method='nt')
